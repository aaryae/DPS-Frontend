import { faArrowTrendUp, faEye, faEyeSlash, faGear, faStar, faUser } from '@fortawesome/free-solid-svg-icons'
      ...
      <div className='relative overflow-hidden'>
        ...
        <div className='relative p-8 text-white'>
          <div className='flex justify-between items-start mb-8'>
            <div>
              <p className='text-white/80 text-sm font-medium mb-2'>Good {greeting}</p>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
            <div>
              <div className='flex items-center gap-3 mb-4'>
                <p className='text-white/90 text-lg font-medium'>Total Balance</p>
                <button
              ...
              <h1 className='text-5xl font-bold mb-4'>{showBalance ? '₹ 2,45,670' : '₹ ••••••'}</h1>
              <p className='text-white/80 mb-6'>Account: ****4829 • Savings</p>

              <div className='flex gap-4'>
                <button className='bg-white text-indigo-600 px-6 py-3 rounded-2xl font-semibold flex items-center gap-2 hover:bg-white/90 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300'>
            ...
            <div className='space-y-4'>
              <div className='bg-white/10 backdrop-blur-sm p-4 rounded-2xl'>
                <div className='flex items-center justify-between mb-2'>
                  ...
                  <FontAwesomeIcon icon={faArrowTrendUp} className='text-emerald-400' size='sm' />
                </div>
              ...
              <div className='bg-white/10 backdrop-blur-sm p-4 rounded-2xl'>
                ...
                <p className='text-yellow-400 text-sm mt-1'>₹75,000 of ₹100,000</p>
              </div>
            </div>
          </div>
        </div>
