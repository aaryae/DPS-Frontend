  ...
  return (
    <div className="bg-white backdrop-blur-xl p-8 rounded-3xl border border-white/20 shadow-xl w-full">
        ...
        <div className="space-y-4">
          {[
            { name: 'Netflix Subscription', amount: '-₹799', time: '2 hours ago', status: 'completed', type: 'expense', icon: '🎬' },
            { name: 'Salary Deposit', amount: '+₹85,000', time: 'Today 9:00 AM', status: 'completed', type: 'income', icon: '💼' },
                      ].map((txn, i) => (
            <div key={i} className="group flex items-center gap-4  rounded-2xl hover:bg-gray-50 transition-all duration-300 cursor-pointer">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className={`font-bold text-lg ${
                      ...
                      txn.type === 'expense' ? 'text-red-500' : 'text-blue-600'
                    }`}>
                      {txn.amount}
                    </p>
